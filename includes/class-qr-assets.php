...
class QR_Assets
{
  ...
  {
    // Solo carga si el shortcode está presente
    if (!is_singular() || !has_shortcode(get_post_field('post_content', get_the_ID()), 'quiz_runner')) {
      return;
    }

    $ver = '2.2.0'; // súbelo en desarrollo para romper caché
    ...
    // Game + Bootstrap (dependen de lo anterior)
